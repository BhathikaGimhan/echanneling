...
if (isset($_POST['update'])) {
    $sql = "UPDATE doctor SET address='" . $address . "',docName='" . $userName . "',telNo='" . $telNo . "',hospital='" . $baseHospital . "',email='" . $email . "',telHome='" . $telHome . "',channelRoomNo='".$channelRoomNo."',priceForChannel='".$priceForChannel."' WHERE id='" . $submit_id . "'";
