...
<div class="w3-top ">
  <div class="w3-bar w3-indigo w3-card w3-padding ">
    ...
    <a href="patient/my_bookings.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">MY BOOKINGS</a>
...
<div class="w3-dropdown-hover w3-hide-small w3-hide-small w3-right">
      ...
      <button class=" w3-button"><i class="fas fa-user-circle fa-2x "></i>&nbsp; Ruwan Wedisa <i class="fa fa-caret-down"></i></button>     
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="updatepassword.php" class="w3-bar-item w3-button">Update Password</a>
        <a href="#" class="w3-bar-item w3-button">Update Details</a>
