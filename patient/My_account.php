...
if(isset($_POST['submit'])){
    ...
    $query1 = "UPDATE patient SET patientName = '".$name."' , address = '".$address."', email = '".$email."', telNo = '".$telephone."' WHERE id='".$userid."'";
                ...
                <div class="panel-body panel-default">
                    <table width="400" border="0" cellspacing="10" cellpadding="10"class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><button onClick ="qr()" value="Changephone" class="btn btn-danger  text-primary"name="submit">Genarate QR code</button></td>
...
<div class="qr_area" id="qrCode" style="display:none; max-width:400px; height:400px; overflow:hidden; background-image:url('./img/QR_code_for_mobile_English_Wikipedia.svg.png'); background-size:cover; ">
