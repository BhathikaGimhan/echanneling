...
<div class="w3-container w3-half w3-margin-top w3-display-middle form-con " style="border-radius:20px; padding-top:70px ; padding-left:80px ;  padding-right:80px">
<header class="w3-container" align="center">
  <h1>Login</h1>
</header>

<form class="w3-container w3-card-4 w3-white form-con " method="post" name="login" >
...
<div class="w3-row w3-section w3 w3-text-black" ><div class=""> Forgot passoword? </div>
  ...
  <button type="submit" class="w3-button w3-block w3-half w3-green w3-section w3-ripple w3-padding" name="login">Login</button>
  <button class="w3-button w3-block w3-half w3-section w3-gray  w3-ripple w3-padding">Cancel</button>
